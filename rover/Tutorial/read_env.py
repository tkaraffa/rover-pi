...
GDOCS_OAUTH_JSON = os.path.join(os.path.dirname(__file__), "auth.json")
...
def login_open_sheet(oauth_key_file, spreadsheet):
    ...
    try:
        ...
        worksheet = gc.open(
            spreadsheet
        ).sheet1  # pylint: disable=redefined-outer-name
        return worksheet
...
print(
    "Logging sensor measurements to\
 {0} every {1} seconds.".format(
